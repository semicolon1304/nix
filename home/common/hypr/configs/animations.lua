...
-- Animations stolen from JaKooLit
...
hl.animation({leaf = "windowsMove", enabled = true, speed = 5, bezier = "slow", style = "popin"})
-- hl.animation({leaf = "border", enabled = true, speed = 10, bezier = "linear"})
-- hl.animation({leaf = "borderangle", enabled = true, speed = 5, bezier = "slow", style = "popin"})
